...
- **원본 이식(포팅) — 완료**: 페이지 `요리 비서 - 세인`, 프레임 `cook/<view>`, 플로우 보드 `FLOW/01`, `scripts/ralph-figma/prd.json` **113/113**. 최종 export는 `scripts/ralph-figma/exports/board-A.png`, `board-B.png`, `board-C.png`.
