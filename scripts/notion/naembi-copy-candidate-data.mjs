...
export const copyCandidateGroups = [
  ...
  },
  {
    ...
    title: '검색 입력 힌트',
    note: '창작자 검색이 음식 검색과 섞여 보이지 않도록 입력 힌트 표현을 고릅니다.',
    candidates: [
      {
        id: 'COPY-011',
        location: '검색 입력 placeholder',
        before: '요리, 재료, 창작자 이름으로 검색',
        after: '요리, 재료, 유튜버 이름으로 검색',
        reason: '유튜브 기반 사용자가 더 빠르게 이해할 수 있는 표현입니다.',
        replacements: [
          { file: 'app.html', from: '요리, 재료, 창작자 이름으로 찾아보세요', to: '요리, 재료, 유튜버 이름으로 찾아보세요' },
          { file: 'app.html', from: '요리, 재료, 창작자 이름으로 검색', to: '요리, 재료, 유튜버 이름으로 검색' }
        ]
      },
      {
        id: 'COPY-012',
        ...
        replacements: [
          { file: 'app.html', from: '요리, 재료, 창작자 이름으로 찾아보세요', to: '요리, 재료, 만든 사람 이름으로 찾아보세요' },
          { file: 'app.html', from: '요리, 재료, 창작자 이름으로 검색', to: '요리, 재료, 만든 사람 이름으로 검색' }
        ]
      }
    ]
  },
    ...
    candidates: [
      {
        ...
        after: '요리 결과와 창작자 결과를 따로 보여줘요.',
        reason: '이번 수정 목표인 결과 분리를 직접 설명합니다.',
        replacements: [
          { file: 'app.html', from: '<b>요리 제목, 재료, 창작자 이름</b>을 함께 보고 가장 가까운 레시피를 먼저 보여줘요.', to: '<b>요리 결과와 창작자 결과</b>를 따로 보여줘요.' },
          { file: 'index.html', from: '요리 이름, 재료, 창작자 이름을 함께 보고 가까운 레시피를 먼저 보여줍니다.', to: '요리 결과와 만든 사람 결과를 따로 보여줍니다.' }
        ]
      },
      {
        id: 'COPY-014',
        ...
        replacements: [
          { file: 'app.html', from: '<b>요리 제목, 재료, 창작자 이름</b>을 함께 보고 가장 가까운 레시피를 먼저 보여줘요.', to: '<b>요리 이름, 재료, 만든 사람 이름</b>으로 찾을 수 있어요.' },
          { file: 'index.html', from: '요리 이름, 재료, 창작자 이름을 함께 보고 가까운 레시피를 먼저 보여줍니다.', to: '요리 이름, 재료, 만든 사람 이름으로 찾을 수 있습니다.' }
        ]
      }
    ]
  },
